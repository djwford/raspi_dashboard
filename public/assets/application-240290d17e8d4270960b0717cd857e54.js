...
$(function () {
  $('#temperature_today').highcharts({
      ...
      series: [{
        ...
        pointStart: 1435471200000,
        data: [79.1366, 79.025, 79.1366, 79.1366, 79.025, 79.025, 79.025, 79.025, 79.025, 79.025, 79.025, 78.9116, 78.9116, 78.9116, 78.9116, 78.9116, 78.9116, 78.8, 78.9116, 78.8, 78.8, 78.8, 78.8, 78.8, 78.8, 78.8, 78.8, 78.8, 78.6866, 78.6866, 78.6866, 78.6866, 78.6866, 78.6866, 78.6866, 78.6866, 78.575, 78.575, 78.575, 78.575, 78.575, 78.4616, 78.4616, 78.4616, 78.4616, 78.4616, 78.4616, 78.4616, 78.6866, 79.7, 79.8116, 79.8116, 79.925, 79.925, 79.925, 80.0366, 80.2616, 80.375, 80.375, 80.375, 80.375, 80.375, 80.375, 80.375, 80.48660000000001, 80.48660000000001, 80.48660000000001, 80.48660000000001, 80.7116, 81.05, 81.1616, 81.1616, 81.1616],
        lineWidth: 3,
        color: "#E8FCB9"
      }]
  });
...
$(function () {
  $('#temperature_month').highcharts({
      ...
      series: [
      {
        ...
        pointStart: 1433138400000,
        data: [76, 90, 81, 80, 78, 80, 81]
      },
      {
        name: "Lows",
        pointInterval: (86400 * 1000),
        pointStart: 1433138400000,
        data: [75, 71, 71, 71, 72, 79, 78]        
...
$(function () {
  $('#temperature_average').highcharts({
      ...
      series: [
      {
        name: "Average Temps.",
        pointInterval: (86400 * 1000),
        pointStart: 1434689977000,
        data: [76, 77, 76, 72, 75, 79, 79]
      }]
  });
});
...
$(function () {
  $('#hourly_forecast_temperature').highcharts({
      ...
      series: [
      {
        ...
        pointStart: 1435104889000,
        data: [88.19, 84.89, 80.56, 76.27, 72.22, 68.36, 65.43, 63.78, 62.9, 62.27, 61.54, 61.17, 62.12, 64.64, 68.22, 72.04, 76.1, 80.34, 83.9, 86.43, 88.47, 90.47, 92.73, 94.7, 95.46, 94.02, 91.33, 88.1, 84.41, 80.52, 77.25, 74.75, 72.53, 70.56, 68.64, 67.18, 67.58, 69.87, 73.38, 77.04, 80.71, 84.49, 87.68, 90.05, 92.08, 94.17, 96.62, 98.8, 99.66]
      },
 
      {
        ...
        pointInterval: (3600 * 1000),
        pointStart: 1435104889000,
        data: [2.36, 2.37, 2.58, 2.64, 2.43, 2.26, 2.31, 2.59, 2.91, 2.87, 2.11, 0.93, 0.22, 0.82, 1.32, 1.5, 1.13, 0.43, 0.16, 0.48, 0.73, 1.01, 1.31, 1.65, 2.12, 2.88, 3.81, 4.55, 4.88, 5.04, 5.3, 5.94, 6.63, 6.65, 5.48, 3.77, 2.65, 2.44, 2.7, 3.04, 3.29, 3.46, 3.59, 3.65, 3.64, 3.61, 3.67, 3.71, 3.48]
      }]
  });
});
...
$(function () {
  $('#hourly_forecast_other').highcharts({
      ...
      series: [
      {
        ...
        pointInterval: (3600 * 1000),
        pointStart: 1435104889000,
        data: [0.96, 0.97, 0.97, 0.98, 0.98, 0.99, 0.98, 0.97, 0.94, 0.89, 0.82, 0.73, 0.62, 0.47, 0.18, 0.05, 0.02, 0.02, 0.02, 0.02, 0.01, 0.01, 0.02, 0.02, 0.02, 0.04, 0.05, 0.11, 0.31, 0.64, 0.76, 0.6, 0.22, 0.06, 0.03, 0.03, 0.04, 0.03, 0.03, 0.02, 0.01, 0, 0, 0, 0, 0, 0, 0, 0]
      },
      {
        name: "Humidity",
        pointInterval: (3600 * 1000),
        pointStart: 1435104889000,
        data: [0.93, 0.86, 0.83, 0.79, 0.75, 0.7, 0.65, 0.61, 0.57, 0.55, 0.57, 0.62, 0.66, 0.68, 0.7, 0.72, 0.74, 0.75, 0.76, 0.76, 0.77, 0.75, 0.71, 0.65, 0.59, 0.54, 0.48, 0.44, 0.4, 0.37, 0.35, 0.34, 0.34, 0.35, 0.38, 0.42, 0.45, 0.47, 0.48, 0.5, 0.53, 0.56, 0.58, 0.61, 0.63, 0.63, 0.6, 0.56, 0.51]
      },
      {
        name: "Cloud Cover",
        pointInterval: (3600 * 1000),
        pointStart: 1435104889000,
        data: [0.22, 0.64, 0.78, 0.88, 0.94, 0.97, 0.95, 0.84, 0.68, 0.54, 0.44, 0.36, 0.27, 0.17, 0.06, 0, 0, 0.04, 0.11, 0.23, 0.38, 0.48, 0.5, 0.48, 0.46, 0.46, 0.47, 0.46, 0.39, 0.31, 0.26, 0.29, 0.37, 0.42, 0.44, 0.43, 0.39, 0.29, 0.14, 0.04, 0.01, 0.02, 0.03, 0.02, 0.01, 0, 0, 0, 0]
      }
      ]
  });
});
